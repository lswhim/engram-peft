...
case "$MODE" in
  ...
  semantic_specificity_k8)
    ...
    ;;
  semantic_specificity_k2)
    TABLE="$SEMANTIC_TABLE"
    EXTRA="memory_fusion=head_factorized,head_router_top_k=2,head_router_preserve_mass=True,head_router_selection=specificity,head_router_use_null=False,credit_loss_weight=0.0"
    ;;
